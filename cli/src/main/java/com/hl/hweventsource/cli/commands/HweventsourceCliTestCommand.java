 ...
 */
package com.hl.hweventsource.cli.commands;
...
public class HweventsourceCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(HweventsourceCliTestCommand.class);
    protected final HweventsourceCliCommands service;

    public HweventsourceCliTestCommand(final HweventsourceCliCommands service) {
